...
public class GolemMetal extends AbstractVendor {
  public GolemMetal() {
    ...
    recipe("coin/copper/1",0, Items.COPPER_INGOT, BlockGameItems.GOLD_COIN);
    recipe("coin/copper/10",0, EmiStack.of(Items.COPPER_INGOT, 10), BlockGameItems.PLATINUM_COIN);

    recipe("coin/iron/1",0, Items.IRON_INGOT, BlockGameItems.GOLD_COIN.copy().setAmount(2));
    recipe("coin/iron/10",0, EmiStack.of(Items.IRON_INGOT, 10), BlockGameItems.PLATINUM_COIN.copy().setAmount(2));

    recipe("coin/gold/1",0, Items.GOLD_INGOT, BlockGameItems.GOLD_COIN.copy().setAmount(3));
